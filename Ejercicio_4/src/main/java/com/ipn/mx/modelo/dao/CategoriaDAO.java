...
public class CategoriaDAO {
    ...
    private static final String SQL_READ_ALL = "select * from Categoria";
     private static final String SQL_COUNT_CATEGORIA_PRODUCTO = "SELECT categoria.nombrecategoria as nombreCategoria, count(*) as count FROM producto INNER JOIN categoria ON producto.idcategoria = categoria.idcategoria group by categoria.idcategoria";
    ...
    private void obtenerConexion() {
        ...
        //Establecemos la parte de la conexión con nuestra DB en el manejador que hemos empleado
        String dsName = "jdbc/postgres";
